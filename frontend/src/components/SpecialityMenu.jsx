...
const SpecialityMenu = () => {
    return (
        <div className='flex flex-col items-center gap-4 py-16 text-grey-800' id='speciality'>
            <h1 className='text-3xl font-medium'>Запис на прийом</h1>
            <p className='sm:w-1/3 text-center text-sm'>Запишіться на прийом в залежності від питання яке вас цікавить</p>
